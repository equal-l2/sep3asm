...
public class Sep3asmTokenRule extends HashMap<String, Object> {
	...
	public Sep3asmTokenRule() {
		...
		put("jmp",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0x4407, from_ops|LABEL, 0)));
		...
		put("rjp",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0x5407, from_ops|LABEL, 0)));
		...
		put("jsr",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xB01E, from_ops|LABEL, 0)));
		put("rjs",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xB41E, from_ops|LABEL, 0)));
		put("svc",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xB81E, from_ops|LABEL, 0)));
		put("brn",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xC007, from_ops|LABEL, 0)));
		put("brz",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xC407, from_ops|LABEL, 0)));
		put("brv",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xC807, from_ops|LABEL, 0)));
		put("brc",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xCC07, from_ops|LABEL, 0)));
		put("rbn",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xE007, from_ops|LABEL, 0)));
		put("rbz",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xE407, from_ops|LABEL, 0)));
		put("rbv",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xE807, from_ops|LABEL, 0)));
		put("rbc",   new TokenAssoc(Sep3asmToken.TK_INSTJ, new JumpInstruction(0xEC07, from_ops|LABEL, 0)));
